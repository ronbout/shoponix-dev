      ...
      <div className="ui grid navbar-area">
        <div className="computer tablet only row">
          <div className="ui inverted fixed menu navbar page grid">
            ...
            <div className="ui simple dropdown item">
              ...
              <div className="menu">
                ...
                <Link href="/furniture">
                  <a
                    className={`item ${
                      isActive("/furniture") ? "active" : null
                    }`}
                  >
                ...
                <Link href="/electronics">
                  <a
                    className={`item ${
                      isActive("/electronics") ? "active" : null
                    }`}
                  >
            ...
            <Link href="/sale-request">
              <a
                className={`item ${
                  isActive("/sale-request") ? "active" : null
                }`}
              >
                Sale?
              </a>
                ...
                <>
                  <div className="ui simple dropdown item">
                    ...
                    <div className="menu">
                      ...
                      {hasStore && (
                        <Link href="/stores/dashboard">
                          <a
                            className={`item ${
                              isActive("/stores/dashboard") ? "active" : null
                            }`}
                          >
                            <i className="history icon"></i>
                            Store Dashboard
